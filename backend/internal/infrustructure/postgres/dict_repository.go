...
// 	GetByID(ctx context.Context, dict_id int) (*dictionary.Dictionary, error)
// 	Create(ctx context.Context, dict *dictionary.Dictionary) error
// 	Delete(ctx context.Context, dict_id int) error
// 	Update(ctx context.Context, dict *dictionary.Dictionary) error
// }
...
func (r *dictionaryRepository) GetByID(ctx context.Context, dict_id int) (*dictionary.Dictionary, error) {
	query := `SELECT * FROM dictionary WHERE dict_id = $1`
